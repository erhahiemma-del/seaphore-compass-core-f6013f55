...
const PATTERNS: ReadonlyArray<{ intent: Intent; rx: RegExp }> = [
  {
    ...
    rx: /\b(investigate|dig into|deep dive|full picture|due diligence)\b/i,
  },
  { intent: "SANCTIONS_SCREEN", rx: /\b(sanction|blacklist|ofac|un list|watchlist|screen)\b/i },
  {
    intent: "OWNERSHIP_TRACE",
    rx: /\b(owner|ownership|beneficial|ubo|shell company|corporate structure)\b/i,
  },
  {
    intent: "COMPLIANCE_CHECK",
    rx: /\b(compliance|psc|detention|deficienc|class|nimasa|regulator)\b/i,
  },
  {
    intent: "VOYAGE_ANALYSIS",
    rx: /\b(voyage|eta|route|track|position|port call|arrival|departure)\b/i,
  },
