...
export const ENTITY_TYPES = [
  "vessel", "company", "person", "voyage", "cargo", "container",
  "document", "port", "investigation", "evidence", "intelligence_report",
  "agency", "regulation",
] as const satisfies readonly EntityType[];

export const APP_ROLES = ["analyst", "officer", "director", "admin"] as const satisfies readonly AppRole[];
