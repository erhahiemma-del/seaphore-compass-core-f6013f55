...
const KPIS: KpiSpec[] = [
  ...
  },
  {
    ...
    trend: "up",
    confidence: "observed",
    series: sparkSeries(79),
    emphasis: "warn",
  },
  {
    label: "3% Levy Expected",
    value: "₦4.95B",
    delta: "+₦88M",
    trend: "up",
    confidence: "inferred",
    series: sparkSeries(83),
  },
  {
    ...
    <IntelCentreShell
      ...
      filters={
        <>
          ...
          <FilterBlock label="Saved views">
            <SavedViewList views={["Top leakage ports", "3% Levy audit", "Repeat under-declare"]} />
          </FilterBlock>
          ...
          <FilterBlock label="Revenue type">
            <CheckList options={REVENUE_BY_TYPE.map((r) => r.type)} />
          </FilterBlock>
          ...
          <div className="grid gap-3 xl:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
            <Section title="Revenue Leakage Heatmap">
              <div className="h-[280px]">
                <NigeriaMap variant="heatmap" className="h-full" />
              </div>
            </Section>
                ...
                columns={[
                  {
                    key: "p",
                    label: "Port",
                    render: (r: (typeof TOP_RISK_PORTS)[number]) => r.port,
                  },
                  {
                    key: "r",
                    label: "Revenue at Risk",
                    align: "right",
                    render: (r) => naira(r.revenueAtRiskNGN),
                  },
                  { key: "c", label: "%", align: "right", render: (r) => `${r.contributionPct}%` },
                  {
                    ...
                    label: "Trend",
                    align: "center",
                    render: (r) => <TrendCell trend={r.trend} />,
                  },
                ]}
                rows={TOP_RISK_PORTS}
                rowKey={(r) => r.code}
              ...
              columns={[
                {
                  key: "c",
                  label: "Company",
                  render: (r: (typeof TOP_COMPANIES_AT_RISK)[number]) => (
                ...
                },
                {
                  ...
                  label: "Confidence",
                  align: "right",
                  render: () => <ConfidenceChip tier="inferred" size={9} />,
                },
              ]}
      ...
      copilot={
        <CentreCopilot
          ...
          observed={[
            {
              title: "Leakage concentrated at Apapa",
              detail: "Observed 38% of at-risk revenue attributed to Apapa Port.",
              confidence: "observed",
            },
            {
              title: "3% Levy shortfall on tankers",
              detail: "Assessed vs expected variance ↑ 4.7% on Tanker class.",
              confidence: "inferred",
            },
            {
              title: "Repeat under-declaration",
              detail: "Trident Maritime Group crossed 3-strike threshold this month.",
              confidence: "observed",
            },
          ]}
          recommendations={[
            {
              title: "Trigger valuation review — MSCU7811203",
              detail: "Duty exposure ₦88M · confidence 82.",
              confidence: "inferred",
            },
            {
              title: "Audit Trident Maritime FY assessments",
              detail: "5 open exceptions over ₦100M threshold.",
              confidence: "observed",
            },
            {
              title: "Recovery action on outstanding ₦6.8B",
              detail: "Officer sign-off required.",
              confidence: "verified",
            },
          ]}
          historical={[
            {
              title: "Delta Freight · Nov 2025",
              detail: "Under-declaration pattern → ₦412M recovered post-review.",
              similarity: 74,
            },
            {
              title: "Sahara Cargo · Q1 2026",
              detail: "3% Levy shortfall → officer decision restored ₦140M.",
              similarity: 61,
            },
          ]}
          related={[
  ...
  return (
    <div className="space-y-2">
      {REVENUE_FUNNEL.map((r, i) => {
        ...
        const conv =
          i > 0 ? ((r.valueNGN / REVENUE_FUNNEL[i - 1]!.valueNGN) * 100).toFixed(0) : "100";
        return (
          <div key={r.stage}>
            ...
            <div key={r.stage} className="flex flex-1 flex-col items-center gap-1">
              <div
                ...
                style={{
                  height: `${h}%`,
                  background: colour,
                  opacity: r.kind === "start" || r.kind === "end" ? 1 : 0.85,
                }}
              />
  ...
  return (
    <div className="flex items-center gap-3">
      <svg viewBox="0 0 160 160" className="h-[160px] w-[160px]">
        ...
        <text x="80" y="78" textAnchor="middle" fill="#E4E8EC" fontSize="14" fontWeight={700}>
          {naira(total)}
        </text>
        <text x="80" y="94" textAnchor="middle" fill="#5A6B7B" fontSize="9">
          collected
        </text>
      </svg>
