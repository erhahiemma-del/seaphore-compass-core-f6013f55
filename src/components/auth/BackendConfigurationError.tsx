      ...
      <main className="flex flex-1 items-center justify-center px-6 py-16">
        <div className="w-full max-w-lg border-l-2 border-destructive pl-6">
          ...
          <p className="mt-3 text-sm leading-6 text-muted-foreground">
            The browser build is missing its Lovable Cloud connection settings. No intelligence data
            was loaded, and authentication remains locked until the connection is restored.
          </p>
