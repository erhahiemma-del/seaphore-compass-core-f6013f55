 ...
 */
export function CopilotCards({ cards, className }: { cards: CopilotCard[]; className?: string }) {
  return (
      ...
      {cards.map((c) => (
        ...
        >
          <div>
            ...
            <div className="mt-1.5 text-[13px] font-semibold text-foreground">{c.title}</div>
