    ...
    >
      ...
      {idle ? (
        <span
          ...
          className="animate-in fade-in slide-in-from-bottom-1 absolute bottom-full left-0 z-10 mb-9 flex w-max whitespace-nowrap items-center gap-1 rounded-full border border-border/60 bg-background px-2 py-0.5 text-[10px] font-medium tracking-tight text-muted-foreground shadow-sm duration-500"
        >
          {NUDGES[nudge]}
          <span
            className={cn(
