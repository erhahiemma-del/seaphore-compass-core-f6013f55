...
export function brokeredPreviewStorage() {
  ...
  const request = (
    ...
    new Promise((resolve) => {
       ...
       * before the timeout is ever created — a reply that arrives on the
       * first tick calls it from `onMessage`. Declaring `const timer` at
       * the assignment below would put that read in the temporal dead
       * zone and throw a ReferenceError on exactly the fast path this
